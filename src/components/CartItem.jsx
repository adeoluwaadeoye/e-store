  ...
  return (
    <div className='flex gap-x-4 py-2 lg:px-6 border-b border-gray-200 w-full font-light text-gray-500'>
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        text-sm'>
          {/* Qty */}
          <div className='flex flex-1 max-w-[100px] item-center h-full
          border text-primary font-medium'>
            {/* minus icon */}
            <div onClick={() => decreaseAmount(id)} className='flex-1 
            flex justify-center items-center cursor-pointer h-full'>
            <IoMdRemove />
            </div>
            {/* amount */}
            ...
            {/* Plus icon */}
            <div onClick={()=> increaseAmount(id)} className='flex-1 h-full
          ...
          <div className='flex-1 justify-end items-center flex text-primary font-medium'>{`$ ${parseFloat(price * amount).toFixed(2)}`}</div>
        </div>
        </div>
      </div>
    </div>
